    ...
    return (
        <>
            ...
            <div className="w-full bg-gray-100 ">
                <div className="max-w-7xl shadow-2xl lg:pr-20 lg:pl-20 mx-auto pt-35 pb-17 px-4 flex flex-col md:flex-row gap-10 bg-white rounded shadow-lg">
                    {/* Left: Images */}
                    <div className="relative w-full md:w-1/2 rounded border border-gray-200 overflow-hidden ">
                        ...
                        <div
                            className="relative w-full h-40 sm:h-96 overflow-hidden rounded cursor-zoom-in"
                        ...
                        >
                            <Image
                                ...
                                fill
                                className={`object-cover rounded transition-transform duration-500 ease-in-out ${isZoomed ? 'scale-125' : 'scale-100'}`}
                            />
                    ...
                    <div className="flex-1 flex flex-col justify-between">
                        <div>
                            ...
                            {/* Color Selector */}
                            <div className="mb-6">
                                <label className="block text-gray-800 mb-1 font-semibold"> Color:

                                    <select
                                        className="border border-gray-400 rounded px-3 py-2 bg-gray-100 text-gray-900 focus:outline-none focus:ring-2 ms-2"
                                        value={selectedColor}
                                        onChange={e => {
                            ...
                            {Number(product?.discount) > 0 ? (
                                <>
                                    ...
                                    <p className="text-xl text-gray-400 line-through">
                                        Rs {(!isNaN(Number(product?.price)) ? Number(product?.price) : 0).toFixed(2)}
                                    </p>
                                    ...
                                    <p className="text-lg font-semibold text-black mr-50">
                                        ...
                                        {(
                                            ...
                                            (1 - (!isNaN(Number(product?.discount)) ? Number(product?.discount) : 0) / 100)
                                        ).toFixed(2)}
                                    </p>
                                </>
                            ) : (
